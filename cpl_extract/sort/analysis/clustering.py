...
import pywt
import umap
from clustersort.analysis import analysis as sas
from clustersort import cluster
...
def compute_waveform_metrics(waves, n_pc=3, umap=False):
    ...
    umap : bool (optional)
        if True, use UMAP to reduce dimensionality of waveforms
...
class SpikeDetection:
    ...
    def __init__(self, file_dir, electrode, params=None, overwrite=False):
        ...
        self._out_dir = os.path.join(
            file_dir, "spike_detection", "electrode_%i" % electrode
        )
