...
class BinaryFile:
    def __init__(
        ...
        """
        Creates/Opens a cpl_extract BinaryFile for reading and/or writing image data that acts like numpy array
...
class BinaryFileCombined:
    def __init__(
        ...
        """
        Creates/Opens a cpl_extract BinaryFile for reading image data across planes
