...
def defaults():
    ...
    return {
        # Suite2p version
        "spk2extract_version": version,  #current version of spk2extract used for pipeline
        ...
        "save_folder": [],  # directory you"d like spk2extract results to be saved to
        "subfolders": [
        ...
        # cell detection settings with spk2extract
