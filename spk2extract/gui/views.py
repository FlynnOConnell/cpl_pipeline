...
class RangeSlider(QSlider):
    ...
    This class emits the same signals as the QSlider base class, except valueChanged
    ...
    def mousePressEvent(self, event):
        ...
        # sliders total range, but not on the slider part of the control
