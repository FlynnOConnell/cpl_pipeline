...
from cpl_pipeline.gui import menu, io
from cpl_pipeline.gui.traces import (
    QRangeSlider,
    WaveformPlot,
    PlotDialog,
    ClusterSelectors,
...
from cpl_pipeline.gui.widgets import MultiSelectionDialog
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("cpl_pipeline")
