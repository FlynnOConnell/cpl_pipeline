...
from cpl_pipeline.plot.data_plot import (
...
from cpl_pipeline.spk_io import printer as pt, writer as wt, userio, h5io
from cpl_pipeline.spk_io.paramio import load_params, write_params_to_json
from cpl_pipeline.spk_io.h5io import (
    get_h5_filename,
...
from cpl_pipeline.utils.spike_sorting_GUI import launch_sorter_GUI, SpikeSorterGUI


def circus_clust_run():
    from cpl_pipeline.analysis.circus_interface import circus_clust as circ
...
class Dataset(objects.data_object):
    ...
    def extract_data(self, filename=None,merge=False):
        ...
        .. seealso::
            :func:`cpl_pipeline.spk_io.h5io.create_empty_data_h5`
            :func:`cpl_pipeline.spk_io.h5io.create_hdf_arrays`
    ...
    def palatability_calculate(self, shell=False):
        from cpl_pipeline.analysis import palatability_analysis as pal_analysis
...
def port_in_dataset(rec_dir=None, shell=False):
    ...
    with open(dat.log_file, "a") as f:
        print(
            "\n==========\nPorting dataset into cpl_pipeline format\n==========\n",
            file=f,
        )
        print(dat, file=f)
