...
from cpl_pipeline import spk_io as spk_io
from cpl_pipeline.analysis import spike_analysis as sas
...
from cpl_pipeline.plot import shader
...
def plot_traces_and_outliers(h5_file: str, window=2, save_file=None):
    """
...
def plot_cluster_pca(clusters):
    ...
    clusters : ilist of dict
        ...
        cpl_pipeline.analysis.spike_sorting
...
def plot_cluster_raster(clusters):
    """
    Plot raster view of a cluster from cpl_pipeline.analysis.spike_sorting
...
def plot_trial_raster(
    ...
    TODO: convert this from cpl_pipeline.plotting.hmm_plot to cpl_pipeline.plotting.plot_blechpy
    Parameters
    ----------
